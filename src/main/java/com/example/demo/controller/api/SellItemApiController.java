...
public class SellItemApiController {
    ...
    @GetMapping("/list")
    public ResponseEntity<Message> showList(@RequestParam("mallName") String mallName, @RequestParam("startDate") Date startDate, @RequestParam("endDate") Date endDate) throws IOException{
